		...
		'menu' => array(
			...
			'items' => array(
					array(
							'title'=>'建立控制器' ,
							'link' => '?c=org.opencomb.mvcmerger.merger.ControllerBuilder' ,
							'quote' => 'c=org.opencomb.mvcmerger.merger.ControllerBuilder' ,
					) ,
					array(
							'title'=>'控制器融合' ,
							'link' => '?c=org.opencomb.mvcmerger.merger.ControllerMerger' ,
							'quote' => 'c=org.opencomb.mvcmerger.merger.ControllerMerger' ,
					) ,
					array(
							'title'=>'建立模板' ,
							'link' => '?c=org.opencomb.mvcmerger.merger.TemplateBuilder' ,
							'quote' => 'c=org.opencomb.mvcmerger.merger.TemplateBuilder' ,
					) ,
					array(
							'title'=>'模板编织' ,
							'link' => '?c=org.opencomb.mvcmerger.merger.TemplateWeaver' ,
							'quote' => 'c=org.opencomb.mvcmerger.merger.TemplateWeaver' ,
					) ,
					array(
							'title'=>'视图布局' ,
